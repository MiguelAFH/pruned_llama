...
logger = setup_logger('../../plots', '10_generate_high_pruning_finetuned_performance_graphs.log')

def main():
    sns.set(style='whitegrid')
    
    logger.info('Generating plots for 10_generate_high_pruning_finetuned_performance_graphs')
    input_path = '../../data/HighPruningRatioPerformance.csv'
    output_path = '../../plots/10_generate_high_pruning_finetuned_performance_graphs.png'
